...
.topbar { background: #1a3fff; color: white; padding: 1.25rem 1.5rem; border-radius: 12px; margin-bottom: 1rem; display: flex; align-items: center; gap: 16px; }
.topbar img { height: 36px; flex-shrink: 0; background: white; padding: 4px 8px; border-radius: 6px; }
